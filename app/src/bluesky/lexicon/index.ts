...
export class ModerationNS {
  ...
  createReport<AV extends AuthVerifier>(
    cfg: ConfigOf<AV, ComAtprotoModerationCreateReport.Handler<ExtractAuth<AV>>>
  ) {
...
export class ServerNS {
  ...
  createInviteCode<AV extends AuthVerifier>(
    cfg: ConfigOf<AV, ComAtprotoServerCreateInviteCode.Handler<ExtractAuth<AV>>>
  ) {
  ...
  listAppPasswords<AV extends AuthVerifier>(
    cfg: ConfigOf<AV, ComAtprotoServerListAppPasswords.Handler<ExtractAuth<AV>>>
  ) {
